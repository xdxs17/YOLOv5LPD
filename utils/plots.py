...
def color_list():
    ...
    """
    return ['#FF3838', '#FF9D97', '#FF701F', '#FFB21D', '#CFD231', '#48F90A', '#92CC17', '#3DDB86', 
            '#1A9334', '#00D4B6', '#2C99A8', '#00C2FF', '#344593', '#6473FF', '#0018EC', '#8438FF', 
...
def plot_one_box(x, im, color=None, label=None, line_thickness=3):
    """
    Plots one bounding box on image with cv2
    """
